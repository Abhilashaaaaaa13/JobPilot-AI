...
if parsed_data:
    with st.expander("Parsed resume — verify it", expanded=False):
...
st.caption("Used in Cold email for sender introduction")
...
target_roles_text = st.text_area(
    ...
    height = 80,
    help   = "Autofilled from resume-you can edit"
)
...
st.caption(
    "Outreach emails will be sent from your gmail. "
